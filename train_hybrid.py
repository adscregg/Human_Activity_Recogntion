...
BATCH_SIZE = 128
WEIGHTS_PATH = './weights/Hybrid_J2/'
SUMMARIES_PATH = './model_summaries/Hybrid_J2/'
DEVICE = 'cuda'
...
scattering_dir = 'C:/Local/scattering_coeffs_not_pooled_J2_88/'
...
ScatNet = ScatNetCNNHybrid(J = 2, L = 8).to(DEVICE)
