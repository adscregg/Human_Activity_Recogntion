...
BATCH_SIZE = 128
WEIGHTS_PATH = './weights/ScatNet_Deep/'
SUMMARIES_PATH = './model_summaries/ScatNet_Deep/'
DEVICE = 'cuda'
...
scheduler = optim.lr_scheduler.StepLR(optimiser, gamma = 0.2, step_size = 50)
